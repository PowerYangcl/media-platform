...
<script type="text/javascript" src="${js}/ueditor/lang/zh-cn/zh-cn.js"></script> 
 ...
 <script type="text/javascript">
	...
	function addInfo(type) {
		...
		var type_ = 'post';
		var url_ = '${basePath}media/ajax_article_add.do';
	...
	<div id="validation" class="subcontent" style="display: block">
		<form id="form-example" class="stdform" method="post" action="" >
			<p>
				<label>标题</label> 
				<span class="field"> 
					<input type="text" name="title" id="title" class="ae-form-input" maxlength="30" placeholder="必填字段 5~30个字"/>
				</span>
			</p>
			<p>
				<label>标题小图</label>
				...
				<div class="field" id="show_upload_image_div" ></div>
				<span class="field" style="color:red">建议尺寸：240像素*180像素</span>
			</p>
			<p>
				<label>文章来源</label> 
				<span class="field"> 
					<input type="text" name="source" id="source" class="ae-form-input" maxlength="10" placeholder="必填字段 1~10个字"/>
				</span>
			</p>
			...
			<p>
				<label>原文链接</label> 
				<span class="field"> 
					<input type="text" name="outUrl" id="outUrl" class="ae-form-input" maxlength="200"/>
				</span>
			</p>
		</form>
	</div>
		...
		<div id="dyntable2_wrapper" class="dataTables_wrapper">
			...
			<div class="subcontent" style="display: block; margin-top: 10px; margin-left: 20px">
				...
				<div  class="dataTables_wrapper" style="margin-top:10px;">
					...
					<table class="stdtable" id="relProductInfo" style="width:700px;">
						<thead>
							<tr>
								<th>商品编号</th>
								<th>商品名称</th>
