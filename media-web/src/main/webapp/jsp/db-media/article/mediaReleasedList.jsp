		...
		if (list.length > 0) {
			for (var i = 0; i < list.length; i++) {
				html_ += '<tr id="tr-' + list[i].id + '" class="gradeX">'
						...
						+ '<td width="100px">' + list[i].source + '</td>'
						+ '<td width="100px">' + list[i].author + '</td>'
						+ '<td width="100px">' + list[i].createTime + '</td>'
						+ '<td width="100px">' + list[i].releaser + '</td>'
						+ '<td width="100px">' + list[i].releaseTime + '</td>'
						+ '<td width="100px">' + list[i].assort + '</td>'
						+ '<td width="150px">'
						...
						+ '<td width="150px" align="center">'
							+ '<a href="${basePath}media/media_article_preview_page.do?id='+list[i].id+'" target="_blank" articleId="' + list[i].id + '"  title="点击此处预览文章"  style="cursor: pointer;">预览</a> | '
			...
			<table id="dyntable2" cellpadding="0" cellspacing="0" border="0" class="stdtable">
				<thead>
					<tr>
						...
						<th class="head0" width="100px">文章来源</th> 
						<th class="head0" width="100px">作者</th>
						<th class="head0" width="100px">创建时间</th>
						<th class="head0" width="100px">发布人</th>
						<th class="head0" width="100px">发布时间</th>
						<th class="head0" width="100px">分类</th>
						<th class="head0" width="150px">访问量</th> 
