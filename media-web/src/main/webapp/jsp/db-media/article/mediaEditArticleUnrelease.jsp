...
<div class="centercontent">
	...
	<a style="margin-left: 220px;"> 
		<button style="margin-bottom:100px"  onclick="addInfo('01')" class="stdbtn btn_orange">保存到待发布</button>
	</a>
<!-- 	<a style="margin-left: 220px ;"> 
		<button style="margin-bottom:100px" onclick="addInfo('02')" class="stdbtn btn_orange">提交到已发布</button>
	</a> -->
</div>
